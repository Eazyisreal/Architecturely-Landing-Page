    ...
    <>
      ...
      >
        ...
        <div className="p-[4rem] wrapper flex flex-col gap-2 max-sm:gap-10 max-lg:gap-72 max-md:flex-col max-lg:flex-row ">
          <p className=" mt-[12rem] mb-[3rem] text-white  text-[2.5rem] max-md:mt-[15rem]  max-md:text-[6.25rem]  max-md:leading-[100%]  font-normal max-xl:leading-[110%] h-full font-onset max-xl:text-[6.25rem] ">
