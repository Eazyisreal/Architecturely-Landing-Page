                ...
                <div className="pt-20 flex">
                    <div className=" flex  flex-col max-md:px-[8rem] max-lg:px-[20rem]">
                        ...
                        <p className="pt-8 font-onest max-md:text-2 max-md:leading-[2.2] xl max-lg:leading-[2] text-[#424242] text-xl leading-[2] ">
                            I had the pleasure of working with Architecturely on a
                            commercial development project and I couldn't be happier with
                            the results. Their team was incredibly professional and
                            attentive to our needs, and they delivered a design that
                            exceeded our expectations.
                        </p>
                        <div className="pt-8 flex-col flex">
                            <div className="flex gap-4">
                                 <img className="max-md:w-1/12 w-2/12 " src={kim} alt="A man's Photo" />
                                <div className="flex flex-col gap-2  ">
                                    <h3 className="font-onest text-black text-xl font-semibold">Kim Davids</h3>
                                    <p className="font-onest font-normal text-base text-[#424242]">CEO of Maddy tech</p>
                                </div>
                            </div>
